...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    videoDescription: '실제 사용자 시나리오를 바탕으로 온보딩부터 루틴 완료까지의 과정을 프로토타입으로 구현해\n헤이브로 앱의 핵심 루틴 여정을 담았습니다.\n\n2030 남성들에게 큰 인기를 끈 유튜버 고재영의 \'직접 체험\' 컨셉을 레퍼런스로,\n정해진 루틴을 일정 기간 직접 수행하며 신체 변화를 가시적으로 보여주는 방식으로 구성했습니다.\n\n헤이브로 루틴을 꾸준히 실천했을 때 실제로 어떤 변화가 생기는지를 사용자 시점에서 보여줌으로써\n단순한 기능 소개가 아닌, 실제 사용자가 경험할 여정을 보여주는 데 집중했습니다.',
    images: [
      '/projects/01/1.png',
      '/projects/01/2.png',
      '/projects/01/3.png',
